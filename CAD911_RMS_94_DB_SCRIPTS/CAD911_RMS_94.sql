...
IF NOT EXISTS(SELECT 1 FROM sys.databases WHERE name='CAD911_RMS_94')
	BEGIN
	BEGIN TRANSACTION;  
	...
	if not exists(select * from sys.database_principals where name = '<USER>')
		BEGIN
		CREATE USER <USER> FROM LOGIN <USER> WITH DEFAULT_SCHEMA = dbo;
	...
	if not exists(select * from sys.database_principals where name = '<DOMAIN>\<USER>')
		...
		GRANT EXECUTE ON sys.sp_OACreate TO [<DOMAIN>\<USER>] ;

		GRANT EXECUTE ON sys.sp_OADestroy TO [<DOMAIN>\<USER>] ;

		GRANT EXECUTE ON sys.sp_OAMethod TO [<DOMAIN>\<USER>] ;

		GRANT EXECUTE ON sys.xp_cmdshell TO [<DOMAIN>\<USER>] ;
    ...
    CREATE DATABASE CAD911_RMS_94;
	GO

	ALTER DATABASE CAD911_RMS_94  SET TRUSTWORTHY ON;
	GO
...
IF OBJECT_ID('dbo.EVCOMM', 'U') IS NOT NULL 
  DROP TABLE  EVCOMM;

IF OBJECT_ID('dbo.AEVEN', 'U') IS NOT NULL 
	DROP TABLE AEVEN;

IF OBJECT_ID('dbo.EV_DISPO', 'U') IS NOT NULL 
	DROP TABLE EV_DISPO;
	
IF OBJECT_ID('dbo.UN_HI', 'U') IS NOT NULL 	
	DROP TABLE UN_HI;
	
IF OBJECT_ID('dbo.UN_HI_PERSL', 'U') IS NOT NULL 	
	DROP TABLE UN_HI_PERSL ;
	
IF OBJECT_ID('dbo.CASE_NUM', 'U') IS NOT NULL 		
	DROP TABLE  CASE_NUM;
	
IF OBJECT_ID('dbo.PERSL', 'U') IS NOT NULL 
	DROP TABLE  PERSL;
	
IF OBJECT_ID('dbo.COMMON_EVENT_CALL', 'U') IS NOT NULL 
	DROP TABLE  COMMON_EVENT_CALL ;
	
IF OBJECT_ID('dbo.PERSO', 'U') IS NOT NULL 
	DROP TABLE   PERSO ;
	
IF OBJECT_ID('dbo.VEHIC', 'U') IS NOT NULL 	
	DROP TABLE  VEHIC;
	
IF OBJECT_ID('dbo.DERIVED_DATA', 'U') IS NOT NULL 	
...
IF OBJECT_ID('dbo.RMSwithOpenXML', 'U') IS NOT NULL
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.RMSwithOpenXML TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EVCOMM TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.AEVEN TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EV_DISPO TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.UN_HI TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.UN_HI_PERSL TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.CASE_NUM TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.PERSL TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.COMMON_EVENT_CALL TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.PERSO TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.VEHIC TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.DERIVED_DATA TO <USER> ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EVENT TO <USER> ;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.RMSwithOpenXML TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EVCOMM TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.AEVEN TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EV_DISPO TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.UN_HI TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.UN_HI_PERSL TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.CASE_NUM TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.PERSL TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.COMMON_EVENT_CALL TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.PERSO TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.VEHIC TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.DERIVED_DATA TO [<DOMAIN>\<USER>] ;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON dbo.EVENT TO [<DOMAIN>\<USER>] ;
